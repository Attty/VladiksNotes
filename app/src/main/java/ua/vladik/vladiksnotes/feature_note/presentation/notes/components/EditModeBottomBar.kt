                ...
                Row(
                    ...
                    if(!isDeleteScreen){
                        Column(
                            modifier = Modifier
                                .fillMaxHeight()
                                .clickable(list.isNotEmpty()) { onMoveToClick.invoke() },
                            horizontalAlignment = Alignment.CenterHorizontally,
                            verticalArrangement = Arrangement.SpaceEvenly
                        ) {
                            Icon(
                                modifier = Modifier.rotate(90f),
                                imageVector = Icons.Default.Upload, contentDescription = "Move To",
                    ...
                    Column(
                        modifier = Modifier
                            .fillMaxHeight()
                            .clickable(list.isNotEmpty()) { onDeleteClick.invoke() },
                        horizontalAlignment = Alignment.CenterHorizontally,
                        verticalArrangement = Arrangement.SpaceEvenly
                    ) {
                        Icon(
